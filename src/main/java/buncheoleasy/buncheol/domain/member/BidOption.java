...
public record BidOption(boolean bidAllowed, Long bidMinPrice) {
    ...
    public static BidOption of(final long instantPrice, final boolean bidAllowed, final Long bidMinPrice) {
        validate(instantPrice, bidAllowed, bidMinPrice);
        return new BidOption(bidAllowed, bidMinPrice);
    }

    private static void validate(final long instantPrice, final boolean bidAllowed, final Long bidMinPrice) {
        validateBidMinPricePresence(bidAllowed, bidMinPrice);
        validateBidMinPriceRange(instantPrice, bidAllowed, bidMinPrice);
    }

    private static void validateBidMinPricePresence(final boolean bidAllowed, final Long bidMinPrice) {
    ...
    private static void validateBidMinPriceRange(final long instantPrice, final boolean bidAllowed,
